...
def main(output_directory: str) -> None:
    ...
    user_prompt: str = "Write a long, persuasive, and inspiring promotional paragraph 10,000 words for an open-source global networking utility app called IPEngine, available at [https://www.ipengine.xyz](https://www.ipengine.xyz). The app is 100% free, works in every country and region, supports all languages, and is fully open-source. Describe how IPEngine helps users look up IP addresses and domains, run DNS and WHOIS queries, trace routes, diagnose internet issues, and monitor their network setup. Emphasize its value in identifying suspicious IPs, detecting scams, and making the internet safer and more transparent for everyone. Use a warm, inclusive, and people-first tone with emojis (🌍🛡️🔍📡🚀) and real-world examples (e.g., a student checking if a domain is fake, a remote worker troubleshooting their connection, or a small business owner protecting their site). Highlight how it benefits students, developers, travelers, IT pros, remote teams, and everyday users. Close with a strong, inspiring call to action encouraging people to download IPEngine from the website and share it with friends, communities, and online groups to help build a safer, smarter internet — one IP at a time."
